// Tests for shared/session.mjs (the in-process persistent-session registry) and
// shared/codex/session.mjs (persistent codex thread), both exercised with fakes — no real
