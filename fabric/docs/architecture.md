...
the full MCP tool surface, or the LAN node fabric protocol/config. Dev-only reference —
the entry-point mental model (4-layer architecture, first principle) stays in `AGENTS.md`.
