...
//   - lib/config.mjs   provider config/env (re-exports engine/providers.mjs)
...
//   - lib/callers.mjs  Codex companion (re-exports engine/anthropic-http.mjs)
...
export { findCodexBinary, checkCodexStatus } from "../engine/codex/discovery.mjs";
