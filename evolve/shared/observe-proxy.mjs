// shared/observe-proxy.mjs — minimal Anthropic-compatible reverse proxy for the
...
//
// Provider routing (upstream/auth/model) comes from shared/providers.mjs — the single
